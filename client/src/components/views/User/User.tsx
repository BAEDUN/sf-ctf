...
export default function User() {
  ...
  const [solvedChallenges, setSolvedChallenges] = useState<
    StatusResponseDtoSolvedChallengesInner[]
  >([]);
  ...
  useEffect(() => {
    ...
    new UserApi(undefined, location.origin)
      .usersControllerStatus({
        accessToken: auth.token,
      })
      .then((response) => {
        const { nickname, score, solvedChallenges, username, email, section } =
          response.data;
          ...
          <div className="Card">
            <div className="Content">
              <form onSubmit={handleSubmit}>
                ...
                <div
                  className="UpdateForm form-outline mb-3"
                  style={{ width: "22rem" }}
                >
                  <input
          ...
          <div className="Card">
            ...
            {solvedChallenges.map((solvedChallenge) => (
              <Fragment key={solvedChallenge.title}>
                ...
                <div>
                  {new Date(solvedChallenge.solvedAt!).toLocaleString()}
                </div>
              </Fragment>
            ))}
          </div>
