...
export default function Register() {
  ...
  const [belong, setBelong] = useState<
    RegisterRequestDtoSectionEnum | undefined
  >(undefined);
        ...
        <form className="Register mt-3" onSubmit={handleSubmit}>
          ...
          <div className="RegForm">
            ...
            >
              ...
              <br />
              허용되는 특수 문자: <span aria-label="exclamation mark">
                !
              </span>{" "}
            ...
            >
              <FontAwesomeIcon icon={faInfoCircle} />첫 번째 비밀번호 입력
              필드와 일치해야 합니다.
            </p>
            ...
            <div className="nickForm">
              <FontAwesomeIcon
                icon={faCheck}
                className={validNick ? "valid" : "hide"}
              />
              <FontAwesomeIcon
                icon={faTimes}
                className={validNick || !nick ? "hide" : "invalid"}
              />
              <MDBInput
                label="Nickname"
                name="nickname"
            ...
            <p
              id="nicknote"
              className={nickFocus && !validNick ? "instructions" : "offscreen"}
            >
              <FontAwesomeIcon icon={faInfoCircle} />
              학번_이름으로 입력해주세요.
            </p>
            <div className="belongForm mt-3">
              <FontAwesomeIcon
                icon={faCheck}
                className={validBelong ? "valid" : "hide"}
              />
              <FontAwesomeIcon
                icon={faTimes}
                className={validBelong || !belong ? "hide" : "invalid"}
              />
              <select
                name="belong"
                ...
                onChange={(event) =>
                  setBelong(event.target.value as RegisterRequestDtoSectionEnum)
                }
                value={belong}
            ...
            <p
              id="belongnote"
              className={
                belongFocus && !validBelong ? "instructions" : "offscreen"
              }
            >
              <FontAwesomeIcon icon={faInfoCircle} />
              소속을 선택해주세요.
            ...
            <MDBBtn
              type="submit"
              className="RegBtn text-dark mt-4"
              color="light"
              disabled={
                !validName ||
                !validPwd ||
